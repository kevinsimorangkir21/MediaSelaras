  ...
  return (
    ...
    <div className='w-full relative h-screen overflow-hidden'>
      ...
      <div className='w-full h-screen flex overflow-hidden'>
        <Image src={medsel} id="bg-gradient" className="flex m-auto w-[30%] h-[30%] lg:h-[15%] lg:w-[15%] sm:h-[20%] sm:w-[20%] md:h-[20%] md:w-[20%]" alt="media selaras logo" />
      </div>
      ...
      <div className='w-[200%] absolute top-0 bg-white'>
      ...
      <div className=' w-[200%] absolute bottom-0 bg-white'>
