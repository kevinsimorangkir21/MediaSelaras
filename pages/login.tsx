          ...
          <div className='flex lg:basis-3/5 justify-center'>
            <div className='self-center w-full px-32'>
              ...
              <div className='flex flex-col pt-9'>
                  ...
                  <input {...register("email", {required: true})} className='py-3 px-4 rounded-md outline-gray-400 outline outline-1' id="username" type="email" placeholder='Masukkan Username'/>
