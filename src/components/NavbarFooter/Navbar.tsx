          ...
          <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8 lg:py-1">
            <div className="w-full relative flex h-16 items-center justify-between">
                ...
                <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify">
                  <div className="hidden lg:block sm:ml-6 ">
                    <div className="flex space-x-4 items-center">
                      <Link href="/">
                        <p className='text-slate-500 cursor-pointer hover:text-black px-3 py-2 rounded-md text-sm font-medium'>Beranda</p>
                      </Link>
                      <Link href="/artikel">
                        <p className='text-slate-500 cursor-pointer hover:text-black px-3 py-2 rounded-md text-sm font-medium'>Artikel</p>
                      </Link>
                      <Informasi />
                      <TentangKami />
                    </div>
              ...
              <div className='hidden lg:block'>
                <div className='bg-[#FAE5DB] inline-flex py-3 px-8 rounded-3xl font-semibold text-[#E77E49] text-sm mr-4 cursor-pointer'>Donasi</div>
                <Link href="/login">
                  <div className='bg-[#E77E49] inline-flex py-3 px-8 rounded-3xl font-semibold text-white text-sm cursor-pointer'>Masuk</div>
                </Link>
              </div>
            </div>
          </div>
