    ...
    <Layout>
      <main>
        ...
        <div className="w-full min-h-screen bg-white overflow-hidden">
          ...
          <section id="media-selaras-podcast" className="Media Selaras Podcast">
            <Animation className="w-full flex gap-14  lg:max-w-7xl m-auto justify-center md:pt-10 lg:pt-14 sm:p-7 ">
              <div className="md:w-2/5 w-full m-auto lg:py-7 sm:p-7 py-2 sm:py-0 px-7 ">
                ...
                <p className="lg:text-base text-sm">
                  Podcast ini ngobrolin isu-isu sosial yang lagi hapening buat dibahas, baik di bidang pendidikan, 
                  ekonomi, environment, kesehatan, serta pemberdayaan masyarakat. Tentunya bermanfaat banget buat didengerin sambil 
                  menjalani aktivitasmu karena bakal banyak info menarik didalamnya. Skuy learning together to getting better.
                </p>
                <Link
            ...
            <Animation className="flex w-full max-w-7xl m-auto lg:pt-14 p-7">
              <div className="lg:w-1/2 lg:basis-1/2 w-full">
                <div className="lg:mt-20 mt-10">
                  <h1 className="lg:text-4xl text-xl font-bold">Hubungi Kami</h1>
